...
const QuestionSec = () => {
  ...
  const data = [
    ...
    { id: 1, name: 'wich of the follwing elements of digital marketing are part of your marketing strategy?' },
      ...
      <div className="row ask-quistion d-flex justify-content-center mt-5">
        ...
        <div className="col-11  mt-3">
          <div className="col-lg-9 d-flex question-bg ">
            ...
            <div className="col-lg-6 col-10 ">
              <h2>Other (e.g search engine optimistion)</h2>
            </div>
          </div>
        </div>
      </div>
